...
<head>
  ...
  <title>Photocopiers And Copy Supplies Ordering System : Order Details</title>
  <!-- Bootstrap -->
    ...
    try {
      ...
      $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
        $stmt = $conn->prepare("SELECT * FROM tbl_orders_a175838, tbl_staffs_a175838_pt2,
          tbl_customers_a175838_pt2 WHERE
  ...
  <div class="row">
    <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
      ...
      <div class="form-group">
          ...
          ?>
          <option value="<?php echo $productrow['fld_product_num']; ?>"><?php echo $productrow['fld_product_name']; ?></option>
          <?php
          }
          $conn = null;
          ?>
